...
import com.airhomestays.app.databinding.CancellationPolicyBinding
    ...
    private fun initEpoxy() {
        ...
        mBinding.rlListingAmenities.withModels {
            ...
            viewholderReviewAndPaySpanText {
                ...
                desc(
                    getString(R.string.cancellation_policy) + " is " + "'" + viewModel.listingDetails.value!!.listingData
                        ?.cancellation?.policyName
                            + "'" + " and you can " + viewModel.listingDetails.value!!.listingData
                ...
                var end = 0
                if (viewModel.listingDetails.value!!.listingData?.cancellation
                        ?.policyName == "Strict"
                )
                    end = 30
                else
                ...
                desc3(
                    viewModel.listingDetails.value!!.listingData?.cancellation?.policyContent
                )
            }
