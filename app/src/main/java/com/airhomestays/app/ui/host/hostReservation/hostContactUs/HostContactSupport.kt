...
import com.airhomestays.app.databinding.DialogContactBinding
...
class HostContactSupport : BaseDialogFragment(), HostContactUsNavigator {
    ...
    val viewModel: HostContactUsViewModel
        get() = ViewModelProvider(this, mViewModelFactory).get(HostContactUsViewModel::class.java)
    ...
    override fun onCreateView(
        ...
        val binding = DataBindingUtil.inflate<DialogContactBinding>(
            inflater,
