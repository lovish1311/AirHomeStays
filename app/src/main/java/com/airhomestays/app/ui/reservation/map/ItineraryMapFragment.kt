package com.airhomestays.app.ui.reservation.map
...
class ItineraryMapFragment: BaseFragment<ListingListingMapBinding, ReservationViewModel>(), OnMapReadyCallback {
    ...
    override val viewModel: ReservationViewModel
        get() = ViewModelProvider(baseActivity!!, mViewModelFactory).get(ReservationViewModel::class.java)
    ...
    private fun subscribeToLiveData() {
        viewModel.reservation.observe(viewLifecycleOwner, Observer { list -> list?.let {
            try {
