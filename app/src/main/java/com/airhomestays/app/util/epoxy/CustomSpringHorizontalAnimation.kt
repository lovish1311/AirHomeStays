...
class CustomSpringHorizontalAnimation {
    companion object{
        ...
        fun spring(recyclerView: RecyclerView){
            val springAnim = recyclerView.let { img ->
                ...
                SpringAnimation(img, DynamicAnimation.TRANSLATION_X, 0f).setSpring(
                        SpringForce()
                                .setFinalPosition(0f)
                ...
                override fun createEdgeEffect(recyclerView: RecyclerView, direction: Int): EdgeEffect {
                    return object : EdgeEffect(recyclerView.context) {
                        ...
                        private fun handlePull(deltaDistance: Float) {
                            ...
                            val sign = if (direction == DIRECTION_RIGHT) -2 else 2
                        ...
                        override fun onAbsorb(velocity: Int) {
                            ...
                            springAnim.setStartVelocity(translationVelocity).start()
                        }
                    }
                }
            }
